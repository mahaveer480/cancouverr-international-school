...
export const Contact = () => {
  return (
    <div className="container-fluid d-flex align-items-center justify-content-center" style={{ background: '#88AFB9', height: '100vh' }}>
      <div className="row w-75 p-4 d-flex justify-content-between">
        {/* Contact Information */}
        <div className="col-md-5 text-white p-4" style={{  borderRadius: '10px' }}>
        ...
        <div className="col-md-6  p-4 rounded" style={{ borderRadius: '10px' }}>
          <form>
            ...
            <div className="mb-3 form-check">
              ...
              <label className="form-check-label c-white" style={{color:"white"}} htmlFor="termsCheck">I accept the <a style={{color:"white"}}   href="#">Terms</a></label>
            </div>
